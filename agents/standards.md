...
Finish with scope, assessed and unassessed coverage, significant supported findings, unresolved conflicts, and stale work. Do not hide gaps behind a percentage or claim certification. A separate `/edw-doc:review` pass can examine the resulting file notes and rule pages.
