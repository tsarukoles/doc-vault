...
Build the vault for the repository configured by the EDW Doc broker. Treat any user-supplied scope as a limit on analysis, not as permission to modify source.
