...
Open `doc-vault/` as an Obsidian vault or read its Markdown in an editor. Start at `index.md`, then choose onboarding, the file map, or a flow investigation.
...
doc-vault/
  ...
  standards/                  Declared standards and observed conventions
  ...
  .system/                    Runtime index, publication state, and review records
```
